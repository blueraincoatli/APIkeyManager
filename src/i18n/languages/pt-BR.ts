export default {
  ...
  searchResults: {
    ...
    copySuccessMessage: "A chave API foi copiada para a área de transferência. Esteja ciente dos riscos de segurança. O sistema limpará a área de transferência em 30 segundos.",
    copyFailed: "Falha ao Copiar",
    copyFailedMessage: "Não foi possível copiar a chave API para a área de transferência",
  ...
  addApiKeyDialog: {
    ...
    batchImportInstructions: "Use o modelo Excel para importar chaves API em lote. Por favor, baixe o modelo primeiro, preencha os dados e depois faça o upload.",
    ...
    requiredColumns: "Colunas obrigatórias: Nome | Chave API | Plataforma | Descrição",
    ...
    previewNotAvailableMessage: "Por favor, use a função de visualização no ambiente desktop",
    previewWindowError: "Erro na janela de visualização",
    error: "Erro",
    
    importSuccess: "Importação Bem-sucedida",
    importSuccessMessage: "{{succeeded}} chaves API importadas com sucesso, {{failed}} falharam",
    ...
    fileFormatErrorMessage: "Por favor, selecione um arquivo Excel (.xlsx ou .xls)",
    ...
    tauriEnvironmentRequired: "Por favor, certifique-se de executar no ambiente desktop Tauri",
    ...
    downloadedToBrowser: "Arquivo baixado para o local padrão de downloads do navegador",
    templateSavedMessage: "O arquivo do modelo Excel \"{{fileName}}\" foi salvo na sua pasta de downloads",
