export default {
  ...
  settings: {
    ...
    about: {
      ...
      version: "v1.0.0",
      description:
        "Un outil moderne de gestion de clés API pour que les développeurs stockent et gèrent des clés API en toute sécurité.",
    },
  },
  ...
  apiKey: {
    ...
    actions: {
      ...
      copyWarning:
        "La clé API a été copiée dans le presse-papiers. Veuillez être conscient des risques de sécurité. Le système effacera le presse-papiers dans 30 secondes.",
  ...
  addApiKeyDialog: {
    ...
    batchImportInstructions:
      "Utilisez le modèle Excel pour importer des clés API par lots. Veuillez d'abord télécharger le modèle, remplir les données, puis télécharger.",
    downloadTemplate: "Télécharger le modèle",
    selectExcelFile: "Sélectionner un fichier Excel",
    supportedFormats: "Formats pris en charge : Fichiers Excel (.xlsx)",
    requiredColumns:
      "Colonnes requises : Nom | Clé API | Plateforme | Description",
    ...
    previewNotAvailableMessage:
      "Veuillez utiliser la fonction d'aperçu dans l'environnement de bureau",
    previewWindowError: "Erreur de la fenêtre d'aperçu",
    error: "Erreur",

    importSuccess: "Importation réussie",
    importSuccessMessage:
      "{{succeeded}} clés API importées avec succès, {{failed}} échecs",
    importFailed: "Échec de l'importation",
    importFailedMessage: "Une erreur s'est produite lors de l'importation",
    importProcessError:
      "Une erreur s'est produite lors du traitement de l'importation",
    ...
    tauriEnvironmentRequired:
      "Veuillez vous assurer d'exécuter dans l'environnement de bureau Tauri",
    ...
    downloadProcessError:
      "Une erreur s'est produite lors du téléchargement du modèle",
    ...
    downloadedToBrowser:
      "Fichier téléchargé vers l'emplacement de téléchargement par défaut du navigateur",
    templateSavedMessage:
      'Le fichier de modèle Excel "{{fileName}}" a été enregistré dans votre dossier de téléchargements',
