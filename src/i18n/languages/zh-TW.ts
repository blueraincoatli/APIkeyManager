export default {
  ...
  searchResults: {
    ...
    copy: "複製",
    copySuccess: "複製成功",
    copySuccessMessage: "API金鑰已複製到剪貼簿，請注意風險。系統將在30秒後自動清空剪貼簿。",
    copyFailed: "複製失敗",
  ...
  addApiKeyDialog: {
    title: "新增API金鑰",
    batchImport: "批次匯入",
    batchImportInstructions: "使用Excel模板批次匯入API金鑰。請先下載模板，填寫資料後上傳。",
    ...
    importSuccess: "匯入成功",
    importSuccessMessage: "成功匯入 {{succeeded}} 個API金鑰，失敗 {{failed}} 個",
    importFailed: "匯入失敗",
