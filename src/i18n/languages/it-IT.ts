export default {
  ...
  settings: {
    ...
    about: {
      ...
      version: "v1.0.0",
      description:
        "Uno strumento moderno di gestione delle chiavi API per gli sviluppatori per memorizzare e gestire in modo sicuro le chiavi API.",
    },
  },
  ...
  apiKey: {
    ...
    actions: {
      ...
      copyWarning:
        "La chiave API è stata copiata negli appunti. Si prega di essere consapevoli dei rischi di sicurezza. Il sistema cancellerà gli appunti tra 30 secondi.",
  ...
  addApiKeyDialog: {
    ...
    batchImportInstructions:
      "Usa il modello Excel per importare chiavi API in lotti. Per favore, scarica prima il modello, compila i dati e poi carica.",
    downloadTemplate: "Scarica Modello",
    selectExcelFile: "Seleziona File Excel",
    supportedFormats: "Formati supportati: File Excel (.xlsx)",
    requiredColumns:
      "Colonne richieste: Nome | Chiave API | Piattaforma | Descrizione",
    ...
    previewNotAvailableMessage:
      "Per favore, usa la funzione di anteprima nell'ambiente desktop",
    previewWindowError: "Errore della finestra di anteprima",
    error: "Errore",

    importSuccess: "Importazione Riuscita",
    importSuccessMessage:
      "{{succeeded}} chiavi API importate con successo, {{failed}} fallite",
    importFailed: "Importazione Fallita",
    importFailedMessage: "Si è verificato un errore durante l'importazione",
    importProcessError:
      "Si è verificato un errore durante l'elaborazione dell'importazione",
    ...
    fileFormatErrorMessage:
      "Per favore, seleziona un file Excel (.xlsx o .xls)",
    ...
    tauriEnvironmentRequired:
      "Per favore, assicurati di eseguire nell'ambiente desktop Tauri",
    ...
    downloadProcessError:
      "Si è verificato un errore durante il download del modello",
    ...
    downloadedToBrowser:
      "File scaricato nella posizione di download predefinita del browser",
    templateSavedMessage:
      'Il file del modello Excel "{{fileName}}" è stato salvato nella tua cartella dei download',
